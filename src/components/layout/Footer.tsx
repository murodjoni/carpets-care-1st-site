      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-12 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <div className="mt-4 flex gap-3">
            <a href={siteConfig.social.facebook} aria-label="Facebook" className="text-muted-foreground hover:text-foreground" target="_blank" rel="noreferrer">
              <FacebookIcon className="size-5" />
            </a>
            <a href={siteConfig.social.instagram} aria-label="Instagram" className="text-muted-foreground hover:text-foreground" target="_blank" rel="noreferrer">
